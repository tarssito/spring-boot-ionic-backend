...
import com.tarssito.cursomc.domain.Pagamento;
import com.tarssito.cursomc.domain.PagamentoComBoleto;
import com.tarssito.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Mesa de Escrit[orio", 300.00);
		...
		Cliente cli1 = new Cliente(null, "Tarssito Pereira", "tarssito@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, passwordEncoder.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "9383893"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "tarssito@hotmail.com", "12497864608", TipoCliente.PESSOAFISICA,
				passwordEncoder.encode("123456"));
		cli2.getTelefones().addAll(Arrays.asList("99221289", "345223828"));
		...
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "43696696", cli2, c2);
		...
		Pagamento pagto1 = new PagamentoComCartao(null, EstatoPagamento.QUITADO, ped1, 6);

		ped1.setPagamento(pagto1);

		Pagamento pagto2 = new PagamentoComBoleto(null, EstatoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"),
				null);
