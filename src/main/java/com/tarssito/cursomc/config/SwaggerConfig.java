...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.tarssito.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do sistema de pedidos desenvolvido em Spring Boot",
				"Esta API é utilizada no projeto ionic do sistema de pedidos", "Versão 1.0",
				"https://github.com/tarssito",
				new Contact("Tarssito Araujo", "https://github.com/tarssito", "tarssito@gmail.com"),
				"Permitido a todos", "https://github.com/tarssito", Collections.emptyList() // Extensions
		);
	}
